...
#import "ToExcelDSFormViewController.h"
#import "ToExcelDSViewController.h"
#import "UIImage+RO.h"
#import "UILabel+RO.h"

@interface ToExcelDSViewController ()
...
@implementation ToExcelDSViewController
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"ToExcelDS"];

    self.navigationItem.title = NSLocalizedString(@"ToExcelDS", nil);
    ...
    [self.behaviors addObject:[ROCreateItemBehavior behaviorViewController:self crudControllerClass:[ToExcelDSFormViewController class]]];
...
- (void)configureCell:(ROTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.titleLabel.text = [NSString stringWithFormat:@"Episode:%@", [item.episode ro_stringValue]];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SearchDSDSItem *item = self.items[(NSUInteger)indexPath.row];
    EXListViewController *destinationViewController = [EXListViewController new];
