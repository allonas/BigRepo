...
@interface EXListDetailViewController ()
...
@implementation EXListDetailViewController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.dataLoader = [[ROSingleDataLoader alloc] initWithDatasource:(NSObject<RODatasource> *)[[DatasourceManager sharedInstance] excelOnlineDS]
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"EXListDetail"];
...
- (void)loadDataSuccess:(Hoja1Item *)item {
