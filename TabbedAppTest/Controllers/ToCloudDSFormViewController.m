...
@interface ToCloudDSFormViewController () <UITextFieldDelegate, ROFormDataDelegate>
...
@implementation ToCloudDSFormViewController
...
- (void) viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"ToCloudDSForm"];
