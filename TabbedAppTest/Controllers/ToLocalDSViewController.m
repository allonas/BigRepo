...
#import "ToLocalDSFormViewController.h"
#import "ToLocalDSViewController.h"
#import "UIImage+RO.h"
#import "UILabel+RO.h"

@interface ToLocalDSViewController ()
...
@implementation ToLocalDSViewController
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"ToLocalDS"];

    self.navigationItem.title = NSLocalizedString(@"ToLocalDS", nil);
    ...
    [self.behaviors addObject:[ROCreateItemBehavior behaviorViewController:self crudControllerClass:[ToLocalDSFormViewController class]]];
...
- (void)configureCell:(ROTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.titleLabel.text = item.custom;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SearchDSDSItem *item = self.items[(NSUInteger)indexPath.row];
    CustomViewController *destinationViewController = [CustomViewController new];
