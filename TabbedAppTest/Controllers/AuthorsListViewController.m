...
#import "AuthorsListDetailViewController.h"
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"AuthorsList"];

    self.navigationItem.title = NSLocalizedString(@"Authors List", nil);
    ...
    [self.behaviors addObject:[ROCreateItemBehavior behaviorViewController:self crudControllerClass:[AuthorsListFormViewController class]]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ListDSDSItem *item = self.items[(NSUInteger)indexPath.row];
    AuthorsListDetailViewController *destinationViewController = [AuthorsListDetailViewController new];
