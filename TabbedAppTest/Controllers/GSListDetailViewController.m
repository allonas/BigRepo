...
@interface GSListDetailViewController ()
...
@implementation GSListDetailViewController
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.dataLoader = [[ROSingleDataLoader alloc] initWithDatasource:(NSObject<RODatasource> *)[[DatasourceManager sharedInstance] googleSheetDS]
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"GSListDetail"];
...
- (void)loadDataSuccess:(Hoja1Schema1Item *)item {
