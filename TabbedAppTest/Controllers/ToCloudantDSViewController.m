...
#import "ToCloudantDSFormViewController.h"
#import "ToCloudantDSViewController.h"
#import "UIImage+RO.h"
#import "UILabel+RO.h"

@interface ToCloudantDSViewController ()
...
@implementation ToCloudantDSViewController
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"ToCloudantDS"];

    self.navigationItem.title = NSLocalizedString(@"ToCloudantDS", nil);
    ...
    [self.behaviors addObject:[ROCreateItemBehavior behaviorViewController:self crudControllerClass:[ToCloudantDSFormViewController class]]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SearchDSDSItem *item = self.items[(NSUInteger)indexPath.row];
    CloudantViewController *destinationViewController = [CloudantViewController new];
