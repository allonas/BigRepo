//
//  BooksListDetailViewController.m
//  TabbedAppTest
//
...
@interface BooksListDetailViewController ()
...
@implementation BooksListDetailViewController
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"BooksListDetail"];
    ...
    [self.behaviors addObject:[ROUpdateItemBehavior behaviorViewController:self crudControllerClass:[BooksListFormViewController class]]];
