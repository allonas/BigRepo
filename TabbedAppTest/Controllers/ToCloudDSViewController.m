...
#import "ToCloudDSFormViewController.h"
#import "ToCloudDSViewController.h"
#import "UIImage+RO.h"
#import "UILabel+RO.h"

@interface ToCloudDSViewController ()
...
@implementation ToCloudDSViewController
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"ToCloudDS"];

    self.navigationItem.title = NSLocalizedString(@"ToCloudDS", nil);
    ...
    [self.behaviors addObject:[ROCreateItemBehavior behaviorViewController:self crudControllerClass:[ToCloudDSFormViewController class]]];
...
- (void)configureCell:(ROTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.titleLabel.text = item.editorial;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SearchDSDSItem *item = self.items[(NSUInteger)indexPath.row];
    BooksViewController *destinationViewController = [BooksViewController new];
