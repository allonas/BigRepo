...
@interface SearchNavFormViewController () <UITextFieldDelegate, ROFormDataDelegate>
...
@implementation SearchNavFormViewController
...
- (void) viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"SearchNavForm"];
