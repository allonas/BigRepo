...
#import "ToMapFormViewController.h"
#import "ToMapViewController.h"
#import "UIImage+RO.h"
#import "UILabel+RO.h"

@interface ToMapViewController ()
...
@implementation ToMapViewController
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"ToMap"];

    self.navigationItem.title = NSLocalizedString(@"To Map", nil);
    ...
    [self.behaviors addObject:[ROCreateItemBehavior behaviorViewController:self crudControllerClass:[ToMapFormViewController class]]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SearchDSDSItem *item = self.items[(NSUInteger)indexPath.row];
    MapViewController *destinationViewController = [MapViewController new];
