...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.dataLoader = [[ROListDataLoader alloc] initWithDatasource:[[DatasourceManager sharedInstance] listDSDS]
...
- (void)viewDidLoad {
    ...
    [self.optionsFilter addDesignFilter:[ROStringFilter filterWithFieldName:kListDSDSItemEDITORIAL
                                                                      value:self.searchDSDSItem.editorial]];
    ...
    [self.behaviors addObject:[ROCreateItemBehavior behaviorViewController:self crudControllerClass:[BooksFormViewController class]]];
    ...
    [self.behaviors addObject:[ROFilterBehavior behaviorViewController:self filterControllerClass:[BooksFilterViewController class]]];
...
- (ROOptionsFilter *)optionsFilter {
    ...
    if (!_optionsFilter) {
        ...
        _optionsFilter.sortColumn = kListDSDSItemAUTOR;
...
- (void)configureCell:(ROTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    ListDSDSItem *item = self.items[(NSUInteger)indexPath.row];
    cell.titleLabel.text = item.aUTOR;
    cell.detailLabel.text = item.tITULO;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ListDSDSItem *item = self.items[(NSUInteger)indexPath.row];
    BooksDetailViewController *destinationViewController = [BooksDetailViewController new];
