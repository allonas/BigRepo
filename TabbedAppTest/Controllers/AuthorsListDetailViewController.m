//
//  AuthorsListDetailViewController.m
//  TabbedAppTest
//
...
@interface AuthorsListDetailViewController ()
...
@implementation AuthorsListDetailViewController
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"AuthorsListDetail"];
    ...
    [self.behaviors addObject:[ROUpdateItemBehavior behaviorViewController:self crudControllerClass:[AuthorsListFormViewController class]]];
