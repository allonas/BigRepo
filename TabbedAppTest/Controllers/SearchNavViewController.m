...
- (void)viewDidLoad {
    ...
    [self.behaviors addObject:[ROCreateItemBehavior behaviorViewController:self crudControllerClass:[SearchNavFormViewController class]]];
    ...
    [self.behaviors addObject:[ROFilterBehavior behaviorViewController:self filterControllerClass:[SearchNavFilterViewController class]]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SearchDSDSItem *item = self.items[(NSUInteger)indexPath.row];
    SearchNavDetailViewController *destinationViewController = [SearchNavDetailViewController new];
