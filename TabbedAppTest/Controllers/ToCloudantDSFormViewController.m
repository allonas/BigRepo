//
//  ToCloudantDSFormViewController.m
//  TabbedAppTest
//
...
@interface ToCloudantDSFormViewController () <UITextFieldDelegate, ROFormDataDelegate>
...
@implementation ToCloudantDSFormViewController
...
- (void) viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"ToCloudantDSForm"];
