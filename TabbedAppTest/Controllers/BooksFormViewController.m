...
@interface BooksFormViewController () <UITextFieldDelegate, ROFormDataDelegate>
...
@implementation BooksFormViewController
...
- (void) viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"BooksForm"];
