...
- (void)viewDidLoad {
    ...
    self.items = @[                       
                       [[ROItemCell alloc] initWithText1:@"Authors List"
                                         atImageResource:@"EMPLOYEES251920.png"
                                                atAction:[[RONavigationAction alloc] initWithRootViewController:self destinationValue:[AuthorsListViewController class]]],
                       [[ROItemCell alloc] initWithText1:@"Books List"
                                         atImageResource:@"NEWS859611.png"
                                                atAction:[[RONavigationAction alloc] initWithRootViewController:self destinationValue:[BooksListViewController class]]]
                  ];
