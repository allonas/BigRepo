...
#import "ToCustomFormViewController.h"
#import "ToCustomViewController.h"
#import "UIImage+RO.h"
#import "UILabel+RO.h"

@interface ToCustomViewController ()
...
@implementation ToCustomViewController
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"ToCustom"];

    self.navigationItem.title = NSLocalizedString(@"To Custom", nil);
    ...
    [self.behaviors addObject:[ROCreateItemBehavior behaviorViewController:self crudControllerClass:[ToCustomFormViewController class]]];
...
- (void)configureCell:(ROTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.titleLabel.text = item.month;
