...
#import "ToMenuFormViewController.h"
#import "ToMenuViewController.h"
#import "UIImage+RO.h"
#import "UILabel+RO.h"

@interface ToMenuViewController ()
...
@implementation ToMenuViewController
...
- (void)viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"ToMenu"];

    self.navigationItem.title = NSLocalizedString(@"To Menu", nil);
    ...
    [self.behaviors addObject:[ROCreateItemBehavior behaviorViewController:self crudControllerClass:[ToMenuFormViewController class]]];
...
- (void)configureCell:(ROTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.titleLabel.text = @"Navigate to Menu";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SearchDSDSItem *item = self.items[(NSUInteger)indexPath.row];
    MenuViewController *destinationViewController = [MenuViewController new];
