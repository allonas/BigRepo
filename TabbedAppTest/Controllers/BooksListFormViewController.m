...
@interface BooksListFormViewController () <UITextFieldDelegate, ROFormDataDelegate>
...
@implementation BooksListFormViewController
...
- (void) viewDidLoad {
    ...
    [[[ROUtils sharedInstance] analytics] logPage:@"BooksListForm"];
